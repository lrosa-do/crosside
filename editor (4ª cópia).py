                ...
                if module:
                    for depend in module.Depends:
                        ...
                        if mdp:
                            ...
                            #for arg in mdp.DesktopSrc.ARGS.ARGLD:
                            #    ARGLD.append(arg)
                ...
                if module:
                    for depend in module.Depends:
                        ...
                        if mdp:
                            ...
                            for arg in mdp.AndroidSrc.ARGS.ARGLD:
                                ARGLD.append(arg)
                    ...
                    if os.path.exists(pathLib):
                        ...
                        self.trace("**** NO LIB ",pathLib," is not compile ")
                ...
                if module:
                    for depend in module.Depends:
                        ...
                        if mdp:
                            ...
                            if os.path.exists(pathLib):
                                ARGLD.append("-l"+lib)
                            for arg in mdp.WebSrc.ARGS.ARGLD:
                                ARGLD.append(arg)
